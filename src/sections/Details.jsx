  ...
  return (
    <div className='flex flex-col lg:flex-row mx-10 lg:mx-40 mb-16'>
      <div className='left-side w-full lg:w-1/2 text-dark-blue mb-3 flex flex-col justify-between'>
        ...
        <p className='text-3xl pb-3 pt-16 leading-tight lg:text-5xl'>
        ...
        {/* Content with padding on bottom */}
        <div className='flex-grow text-xs leading-6 lg:text-base lg:leading-7 pb-16'>
      ...
      <div className='right-side w-full lg:w-1/2 flex flex-col'>
        {services.map(({ title, desc, logo }) => (
          <div key={title} className='bg-card-gray py-3 px-2 mb-3 lg:py-5 lg:h-auto flex flex-col'>
